...
const AddRecordForm = () => {
  ...
  useEffect(() => {
    ...
    fetchInitialData();
  }, [openAddRecordForm]); // eslint-disable-line react-hooks/exhaustive-deps
  ...
  const onFinish = async (values: any) => {
    ...
    if (response) {
      messageApi.success("Tạo phiếu thi đua thành công!");
      form.resetFields();
      setOpenAddRecordForm(false);
      setIsStudentDisabled(true);
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Select
            placeholder="Tìm kiếm nội dung (VD: đi trễ...)"
            size="large"
            showSearch
